...
public class WinScreen : SKNode, TouchHandlerDelegate {
    ...
    public func handleRematch() {
        println("rematch!")
        self.scene!.view!.presentScene(GameScene(size: self.scene!.size, p1: parentScene.userOne, p2: parentScene.userTwo, t: parentScene.theme), transition: SKTransition.fadeWithColor(UIColor.blackColor(), duration: 1.5))
